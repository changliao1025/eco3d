...
// modules
const double dTemperature_all_rain = 273.15 + 5; // unit: kelvin
const double dTemperature_all_snow = 273.15 - 5; // unit: kelvin
const double dFraction_sublimation =
    0.5; // snow, this one should be in snow class
// system
const char slash = '/';
